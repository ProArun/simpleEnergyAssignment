...
public final class SystemServer implements Dumpable {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
        ...
        if (mFactoryTestMode == FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            // MyOEM HwButton assignment (vendor/myoem/libs/hwbutton) - see
            // HWBUTTON_TDD.md #6 / HWBUTTON_FEATURE_SPEC.md Phase 5. The only
            // frameworks/base source edits for this feature are this call site
            // and the corresponding services/core/Android.bp wiring below;
            // HwButtonManagerService itself is sourced entirely from vendor/myoem.
            startHwButtonService(t);
    ...
    /**
     * MyOEM HwButton assignment: starts the vendor/myoem-sourced
     * {@code HwButtonManagerService}, which publishes itself under
     * {@code HwButtonManager.HW_BUTTON_SERVICE} for apps to look up via
     * {@code ServiceManager.getService(...)} (see vendor/myoem/HWBUTTON_TDD.md #6).
     */
    private void startHwButtonService(@NonNull TimingsTraceAndSlog t) {
        t.traceBegin("startHwButtonService");
        mSystemServiceManager.startService(
                com.myoem.hwbutton.HwButtonManagerService.class);
        t.traceEnd();
    }
